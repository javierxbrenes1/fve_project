<?php
/*
  Desarrollador: Javier Brenes Redondo
  Fecha: 24/10/2018
  Descripcion: Se agrega el dia de entrega y los medio de pagos.
  TAGS: <20181024></20181024>
*/
...
//<20181024> Javier Brenes Agrega los nuevos datos en este caso son Dia de entrega y medio de pago
$vlcDiaEntrega = $_GET['DiaEntrega'];
$vlcMedioPago = $_GET['MedioPago'];
//</20181024> Fin
